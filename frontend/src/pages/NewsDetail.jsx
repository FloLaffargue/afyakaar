      ...
      <section className="bg-white border-b border-cream-200">
        <div className="container mx-auto px-4">
          <div className={`max-w-4xl mx-auto py-10 border-l-4 ${catStyle.accent} pl-6`}>
            <RichText html={contentParagraphs[0]} className="text-gray-800 text-xl md:text-2xl leading-relaxed font-medium italic" as="div" />
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div className="lg:col-span-8 space-y-6">
                  {contentParagraphs.slice(1).map((paragraph, index) => (
                    <RichText key={index} html={paragraph} className="text-gray-700 text-lg leading-relaxed" as="div" />
                  ))}
                </div>
