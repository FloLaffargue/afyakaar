...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    ...
    fetchProjectBySlug(slug)
      .then((data) => {
        // Ensure gallery/videos are arrays (they come as JSON from API)
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="flex flex-col">
              ...
              {/* Description courte */}
              <RichText html={project.description} className="text-gray-700 text-lg leading-relaxed mb-8" />
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className={`border-l-4 ${cat.border} bg-white rounded-r-2xl shadow-md p-8 md:p-10`}>
                <div className="flex items-start gap-4">
                  ...
                  <RichText html={project.longDescription} className="text-gray-700 text-lg leading-relaxed" as="div" />
                </div>
              </div>
            </div>
          </div>
